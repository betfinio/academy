...
import { AdvancedLessonBlock } from '@/src/lib/types';
...
const getBlockIcon = (block: AdvancedLessonBlock) => {
    ...
    if (isCompleted) {
        return <div className='text-success rounded-full border-success w-8 h-8 flex justify-center items-center border-2'><Check className='w-4 h-4'/></div>
    }
